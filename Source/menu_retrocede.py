...
class Retrocede(Menu):
    ...
    def draw(self):
        ...
        # draw title
        ui.draw_text(self.surface, "Retrocedendo Nível", (SCREEN_WIDTH // 2, 120), COLORS["title"], font=FONTS["big"], shadow=True, shadow_color=(255,255,255), pos_mode="center")
