...
class GameWindow:
    def __init__(self):
        ...
        self.sprite_4 = pygame.image.load("Assets/Kartea/4.png").convert_alpha()
        ...
        self.sprite_star = pygame.image.load("Assets/Kartea/Star100.png").convert_alpha()
        self.car = Car()
    ...
    def run(self):
        ...
        for i in range(20000):
            ...
            #div_color = dark_rumble if (i // 3) % 2 else dark_road
            ...
            if i % 17 == 0:
                line.spriteX = 2.0
                line.sprite = self.sprite_6

            if i % 50 == 0:  # Pista 1
                line.spriteX = -2
                line.sprite = self.sprite_star
        ...
        while True:
            ...
            self.car.drawCar(self.window_surface,carX,carY)
